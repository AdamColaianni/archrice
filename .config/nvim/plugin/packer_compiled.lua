...
_G.packer_plugins = {
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/home/adam/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
  ...
  ["vim-ReplaceWithRegister"] = {
    loaded = true,
    path = "/home/adam/.local/share/nvim/site/pack/packer/start/vim-ReplaceWithRegister",
  ...
  ["vim-nightfly-guicolors"] = {
    loaded = true,
    path = "/home/adam/.local/share/nvim/site/pack/packer/start/vim-nightfly-guicolors",
